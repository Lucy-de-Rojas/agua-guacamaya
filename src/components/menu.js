...
export default function Menu ({menuOpen, setMenuOpen}) {
        ...
        let styleLink = "bg-orange-400 py-5 text-3xl font-extrabold my-5 rounded-full w-3/4 landscape:my-2";





return (<div className="fixed bg-white left-[-110%] w-[90%] top-[130px] bottom-0 my-5 rounded-xl shadow-2xl flex flex-col justify-center items-center transition-all duration-700 overflow-x-scroll ease-linear z-10 landscape:top-0 landscape:my-0 landscape:justify-start landscape:py-10" id="menu">
